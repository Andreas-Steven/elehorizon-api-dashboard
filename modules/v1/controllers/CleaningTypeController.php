...
use app\models\search\CleaningTypeSearch;

class CleaningTypeController extends CoreController
{
    ...
    public function actionData()
    {
        ...
        $searchModel = new CleaningTypeSearch();
    ...
    public function actionUpdate()
    {
        ...
        $model = CoreController::coreFindModelOne(new CleaningType(), $params);
